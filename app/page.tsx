...
import { MapPin, Thermometer, Wind, Droplets, Gauge, Sun as SunIcon, Map, Globe, Navigation } from 'lucide-react';
          ...
          <Card className="border-2 mb-8">
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-green-100 to-blue-100 dark:from-green-900/30 dark:to-blue-900/30 rounded-lg p-4 border-2 border-green-200 dark:border-green-800">
